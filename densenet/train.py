...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str, default="../dataset/data_ori/flower_photos")

    # densenet121 官方权重下载地址
    # https://download.pytorch.org/models/densenet121-a639ec97.pth
    parser.add_argument('--weights', type=str, default='/home/ubuntu/.cache/torch/checkpoints/densenet121-a639ec97.pth',
